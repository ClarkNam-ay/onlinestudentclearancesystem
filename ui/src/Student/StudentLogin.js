...
function StudentLogin() {
  ...
  return (
    <div className='d-flex justify-content-center align-items-center vh-100' style={{ background: 'linear-gradient(to bottom, #87ceeb, #4682b4)'}}>
        ...
        <Link to="/" style={{backgroundColor: '#1e90ff', color: 'white'}} className='btn position-absolute start-0 top-0 m-3'>
          Go to Frontpage
        </Link>
        <center><h2 className='login-header'>Student Login</h2></center>
