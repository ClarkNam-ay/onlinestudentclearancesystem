...
import Validation from './signeeloginvalidation'
...
function SigneeLogin() {
  ...
  return (
    <div className='d-flex justify-content-center align-items-center vh-100'>
        ...
        <center><h2>Signee Login</h2></center>
        <form action="" onSubmit={handleSubmit}>
                ...
                <Link to="/signeeregister" style={{backgroundColor: '#1e90ff', color: 'white'}} className='btn btn-default border w-100 rounded-0 text-decoration-none'>
                    Create Account
                </Link>
            </form>
        </div>
